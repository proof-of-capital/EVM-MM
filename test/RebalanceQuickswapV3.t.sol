...
contract RebalanceQuickswapV3Test is Test {
    ...
    MockQuickswapV3Router public router;

    address public owner;
    address public admin;

    // Helper function to encode Quickswap V3 (Algebra) path: token0 (20 bytes) + fee (3 bytes) + token1 (20 bytes)
    ...
    function setUp() public {
        ...
        // Deploy router
        router = new MockQuickswapV3Router();
    ...
    function test_rebalancePOCtoPOC_Success() public {
        ...
        // Encode path for Quickswap V3 (Algebra): token0 + fee (3000 = 0.3%) + token1
        ...
        fallenParams[0] = RebalanceParams({
            ...
            swapParams: SwapParams({
                routerType: RouterType.QuickswapV3,
