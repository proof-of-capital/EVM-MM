.PHONY: all build test clean deploy-rebalance-local deploy-rebalance-testnet deploy-rebalance-polygon deploy-rebalance-holesky deploy-rebalance-base deploy-rebalance-arbitrum deploy-rebalance-bsc deploy-rebalance-mainnet help
